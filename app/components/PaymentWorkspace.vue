        ...
        >
          ...
          <div class="grid grid-cols-2 gap-4">
            <button
              ...
              :key="method.code"
              :class="[
                'flex items-center justify-center gap-3 p-5 rounded-[20px] border transition-all duration-300 font-bold text-xs shadow-inner',
...
const handlePaymentSuccess = async (event: Event) => {
  ...
  toast.add({
    ...
    description: `Transaction confirmed. Order ID: ${props.orderId}`,
    color: 'success',
  })
...
const handlePaymentError = (event: Event) => {
  ...
  toast.add({
    ...
    description: detail.message || 'Payment execution reverted',
    color: 'error',
  })
}
